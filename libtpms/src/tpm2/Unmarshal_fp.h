...
extern "C" {
    ...
    LIB_EXPORT TPM_RC TPM2B_PUBLIC_KEY_MLDSA_Unmarshal(TPM2B_PUBLIC_KEY_MLDSA *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_PRIVATE_KEY_MLDSA_Unmarshal(TPM2B_PRIVATE_KEY_MLDSA *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMI_MLDSA_PARAMETER_SET_Unmarshal(TPMI_MLDSA_PARAMETER_SET *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMS_MLDSA_PARMS_Unmarshal(TPMS_MLDSA_PARMS *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMS_HASH_MLDSA_PARMS_Unmarshal(TPMS_HASH_MLDSA_PARMS *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_SIGNATURE_MLDSA_Unmarshal(TPM2B_SIGNATURE_MLDSA *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMS_SIGNATURE_HASH_MLDSA_Unmarshal(TPMS_SIGNATURE_HASH_MLDSA *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_SIGNATURE_CTX_Unmarshal(TPM2B_SIGNATURE_CTX *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_SIGNATURE_HINT_Unmarshal(TPM2B_SIGNATURE_HINT *target, BYTE **buffer, INT32 *size);
#endif
#if ALG_MLKEM
    LIB_EXPORT TPM_RC TPM2B_PUBLIC_KEY_MLKEM_Unmarshal(TPM2B_PUBLIC_KEY_MLKEM *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_PRIVATE_KEY_MLKEM_Unmarshal(TPM2B_PRIVATE_KEY_MLKEM *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMI_MLKEM_PARAMETER_SET_Unmarshal(TPMI_MLKEM_PARAMETER_SET *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPMS_MLKEM_PARMS_Unmarshal(TPMS_MLKEM_PARMS *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_SHARED_SECRET_Unmarshal(TPM2B_SHARED_SECRET *target, BYTE **buffer, INT32 *size);
    LIB_EXPORT TPM_RC TPM2B_KEM_CIPHERTEXT_Unmarshal(TPM2B_KEM_CIPHERTEXT *target, BYTE **buffer, INT32 *size);
#endif
    LIB_EXPORT TPM_RC
