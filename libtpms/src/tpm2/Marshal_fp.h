...
extern "C" {
    ...
    UINT16 TPM2B_SIGNATURE_MLDSA_Marshal(TPM2B_SIGNATURE_MLDSA *source, BYTE **buffer, INT32 *size);
    UINT16 TPMS_SIGNATURE_HASH_MLDSA_Marshal(TPMS_SIGNATURE_HASH_MLDSA *source, BYTE **buffer, INT32 *size);
    UINT16 TPM2B_SIGNATURE_CTX_Marshal(TPM2B_SIGNATURE_CTX *source, BYTE **buffer, INT32 *size);
    UINT16 TPM2B_SIGNATURE_HINT_Marshal(TPM2B_SIGNATURE_HINT *source, BYTE **buffer, INT32 *size);
#endif
#if ALG_MLKEM
    ...
    UINT16 TPM2B_SHARED_SECRET_Marshal(TPM2B_SHARED_SECRET *source, BYTE **buffer, INT32 *size);
    UINT16 TPM2B_KEM_CIPHERTEXT_Marshal(TPM2B_KEM_CIPHERTEXT *source, BYTE **buffer, INT32 *size);
#endif
    UINT16
